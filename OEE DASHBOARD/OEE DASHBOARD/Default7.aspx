<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default7.aspx.cs" Inherits="OEE_DASHBOARD.Default7" %>
        ...
        function message1() {
            $.getJSON('OEEData.txt', function (data) {
                for (var i = 0; i < data.OEEData.length; i++) {
                    ...
                    switch (Ma) {
                        case "BAY03_M1": Ma = "Bay-03-1"; break;
                        case "BAY03_M2": Ma = "Bay-03-2"; break;
                        case "BAY5A1": Ma = "Bay-05-1"; break;
                        case "BAY5B1": Ma = "Bay-05-2"; break;
                        case "BAY6_M1": Ma = "Bay-06-1"; break;
                        case "BAY6_M2": Ma = "Bay-06-2"; break;
                        case "BAY6A_M1": Ma = "Bay-06A"; break;
                        case "BAY8_M1": Ma = "Bay-08-1"; break;
                        case "BAY8A_M1": Ma = "Bay-08A-1"; break;
                        case "BAY8A_M2": Ma = "Bay-08A-2"; break;
                        case "BAY9_M1": Ma = "Bay-09-1"; break;
                        case "BAY9_M2": Ma = "Bay-09-2"; break;
                        default: break;
                    ...
                    if (parseFloat((data.OEEData[i].Availability * 100)) < Availability1) {
                        $("#" + idbar).css({ "width": "150px", "border": "1px solid #e74c3c", "box-shadow": "#333 0px 0px 10px", "height": "16px", "position": "relative" });
                        ...
                        $("#" + idbar).css({ "width": "150px", "border": "1px solid #2ecc71", "box-shadow": "#333 0px 0px 10px", "height": "16px", "position": "relative" });
                        $("#" + idbarrange).css({ "height": "16px", "background": "#2ecc71", "float": "left" });//绿色
                    }
                    else {
                        $("#" + idbar).css({ "width": "150px", "border": "1px solid #ffc300", "box-shadow": "#333 0px 0px 10px", "height": "16px", "position": "relative" });
                    ...
                    if (parseFloat((data.OEEData[i].Performance * 100)) < Performance1) {
                        $("#" + idbar1).css({ "width": "150px", "border": "1px solid #e74c3c", "box-shadow": "#333 0px 0px 10px", "height": "16px", "position": "relative" });
                        ...
                        $("#" + idbar1).css({ "width": "150px", "border": "1px solid #2ecc71", "box-shadow": "#333 0px 0px 10px", "height": "16px", "position": "relative" });
                        $("#" + idbarrange1).css({ "height": "16px", "background": "#2ecc71", "float": "left" });//绿色
                    }
                    else {
                        $("#" + idbar1).css({ "width": "150px", "border": "1px solid #ffc300", "box-shadow": "#333 0px 0px 10px", "height": "16px", "position": "relative" });
                    ...
                    if (parseFloat((data.OEEData[i].Quality * 100)) < Quality1) {
                        $("#" + idbar2).css({ "width": "150px", "border": "1px solid #e74c3c", "box-shadow": "#333 0px 0px 10px", "height": "16px", "position": "relative" });
                        $("#" + idbarrange2).css({ "height": "16px", "background": "#e74c3c", "float": "left" });//红色
                    }
                    else if (parseFloat((data.OEEData[i].Quality * 100)) > Quality2) {
                        $("#" + idbar2).css({ "width": "150px", "border": "1px solid #2ecc71", "box-shadow": "#333 0px 0px 10px", "height": "16px", "position": "relative" });
                        $("#" + idbarrange2).css({ "height": "16px", "background": "#2ecc71", "float": "left" });//绿色
                    }
                    else {
                        $("#" + idbar2).css({ "width": "150px", "border": "1px solid #ffc300", "box-shadow": "#333 0px 0px 10px", "height": "16px", "position": "relative" });
                        ...
                        series: [
                            {
                                ...
                                axisLine: {            // 坐标轴线
                                    lineStyle: {       // 属性lineStyle控制线条样式
                                        color: [[OEE1, '#e74c3c'], [OEE2, '#ffc300'], [1, '#2ecc71']],
                                        width: 8
                                    }
                                },
                                axisTick: {            // 坐标轴小标记
